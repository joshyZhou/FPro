...
parser = argparse.ArgumentParser(description='Image Demoireing using FPro')
#test_resize286_crop256  test_256
parser.add_argument('--input_dir', default='/mnt/sda/zsh/FPro/Demoiring/test_resize286_crop256/thin_source', type=str, help='Directory of validation images')
parser.add_argument('--result_dir', default='./results/FPro_test/', type=str, help='Directory for results')
parser.add_argument('--weights', default='./models/demoire_noAug.pth', type=str, help='Path to weights')
...
####### Load yaml #######
yaml_file = 'Options/RealDemoiring_FPro.yml'
import yaml
