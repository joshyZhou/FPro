...
src = '/home/ubuntu/test/datasets/deblurring/GoPro/train'
...
hr_files = natsorted(glob(os.path.join(src, 'groundtruth', '*.png')) + glob(os.path.join(src, 'groundtruth', '*.jpg')))
...
val_patch_size = 256
src = '/home/ubuntu/test/datasets/deblurring/GoPro/test'
