...
parser.add_argument('--input_dir', default='/home/ubuntu13/zsh/dataset/Uformer/deblurring/', type=str, help='Directory of validation images')
parser.add_argument('--result_dir', default='./results/FPro/', type=str, help='Directory for results')
parser.add_argument('--weights', default='./models/deblur.pth', type=str, help='Path to weights')
...
####### Load yaml #######
yaml_file = 'Options/Deblurring_FPro.yml'
import yaml
