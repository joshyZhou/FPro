...
parser = argparse.ArgumentParser(description='Image Deraindrop using FPro')

parser.add_argument('--input_dir', default='/mnt/sda/zsh/dataset/', type=str, help='Directory of validation images')
parser.add_argument('--result_dir', default='./results/FPro_AGAN/', type=str, help='Directory for results')
parser.add_argument('--weights', default='./models/deraindrop_FPro.pth', type=str, help='Path to weights')
...
####### Load yaml #######
yaml_file = 'Options/RealDeraindrop_FPro.yml'
import yaml
...
for dataset in datasets:
    ...
    inp_dir = os.path.join(args.input_dir, dataset, 'data')
