...
parser = argparse.ArgumentParser(description='Image Dehazning using FPro')

parser.add_argument('--input_dir', default='/mnt/sda/zsh/dataset/haze/promptIR/', type=str, help='Directory of validation images')
parser.add_argument('--result_dir', default='./results/FPro/', type=str, help='Directory for results')
parser.add_argument('--weights', default='/mnt/sda/zsh/FPro/Dehaze/models/synDehaze.pth', type=str, help='Path to weights')
...
####### Load yaml #######
yaml_file = 'Options/RealDehazing_FPro.yml'
import yaml
